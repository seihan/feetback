...
#define MAX_VALUES_SL 2 // arraysize for serial
#define ROWS 1 // vcc
#define COLUMNS 2 // adc
#define READINGS 1 // smooth adc reading 
...
void loop()
{
  ...
  msg.data[ 1 ] = constrain(msg.data[ 1 ], 0, 1000);

  //map values for pwm
  //msg.data[ 0 ] = map(msg.data[ 0 ], 0, 4095, 0, 255);
  msg.data[ 1 ] = map(msg.data[ 1 ], 0, 1000, 0, 255);
  //debug print
