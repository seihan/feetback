...
const int OUTPUT_PINS[ 4 ] = { 2, // OUT1 *
                               3, // OUT2 *
                               4, // OUT3
                               5 // OUT4
                             };
...
void setup()
{
  ...
  Serial.println("Riht Duplex Bracelet");
  Serial.println("-----------------------------\n");
  ...
  Bluefruit.setName("Right Duplex");
...
void loop()
{
  ...
  if ( Bluefruit.Central.connected() )
  {
    ...
    if ( clientUart.discovered() )
    {
      ...
      analogWrite(OUTPUT_PINS[ 0 ], map(pwm_values[ 0 ], 0, 4095, 0, 240));
      analogWrite(OUTPUT_PINS[ 1 ], map(pwm_values[ 1 ], 0, 4095, 0, 240));
